...
wp_enqueue_style('famulus-features-single-with-icon-modern', $sc_dir . 'assets/css/cs_layout6.css', null, null);

?>
<div <?php $this->render_attribute_string('wrapper'); ?>>

	<div <?php $this->render_attribute_string('block_wrapper'); ?>>
		<div class="aheto-content-block__wrap <?php if ( $cs_img_full == true )echo ' aheto-content-block__wrap-img-full ' ?>">
			<?php if ( !empty($s_image )) : ?>
				<?php if ( $cs_img_full == true ):
					$background_image = \Aheto\Helper::get_background_attachment($s_image, $image_size, $atts);
				...
				<?php else: ?>
					<div class="aheto-content-block__image">
						<?php echo \Aheto\Helper::get_attachment($s_image, ['class' => 'svg'],  $image_size, $atts); ?>
					</div>
				<?php endif; ?>
			<?php endif; ?>

			<div class="aheto-content-block__inner <?php if ( $cs_img_full == true )echo ' aheto-content-block__inner-img-full ' ?>">
