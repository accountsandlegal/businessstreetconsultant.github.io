...
wp_enqueue_style('famulus-features-single-with-logo', $sc_dir . 'assets/css/cs_layout7.css', null, null);
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
	...
	<div <?php $this->render_attribute_string('block_wrapper'); ?> <?php echo esc_attr($background_image); ?>>
			...
			<?php if (!empty( $cs_logo) ) : ?>
				<div class="aheto-content-block__image-logo">
					<?php echo \Aheto\Helper::get_attachment($cs_logo, ['class' => '']); ?>
				</div>
			<?php endif; ?>
