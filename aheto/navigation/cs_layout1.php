 ...
 * Set dependent style
 */
$sc_dir = FAMULUS_T_URI . '/aheto/navigation/';
wp_enqueue_style( 'famulus-navigation-header-simple', $sc_dir . 'assets/css/cs_layout1.css', null, null );
wp_enqueue_script( 'famulus-navigation-additional-js', $sc_dir . 'assets/js/cs_layout1.js', array( 'jquery' ), null );
...
<div <?php $this->render_attribute_string( 'wrapper' ); ?>>
	<div class="main-header__main-line">
		...
		<div class="main-header__menu-box">
			<span class="mobile-menu-title"><?php esc_html_e('Menu', 'famulus'); ?></span>
