...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-navbar aheto-navbar--famulus-simple' );
...
wp_enqueue_style( 'famulus-navbar-header-simple', $sc_dir . 'assets/css/cs_layout1.css', null, null );
