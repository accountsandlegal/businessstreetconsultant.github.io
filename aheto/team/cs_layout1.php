...
wp_enqueue_style( 'famulus-team-classic', $sc_dir . 'assets/css/cs_layout1.css', null, null );

?>
<div <?php $this->render_attribute_string('wrapper'); ?>>
	<?php foreach ( $teams as $index => $item ) :
		$background_image = \Aheto\Helper::get_background_attachment($item['member_image'], $item['image_size'] , $atts, '');
		?>
